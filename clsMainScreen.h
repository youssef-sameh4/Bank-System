...
private:
    ...
    {
        AddNewClient::AddNewClint();
    }

    static void _ShowDeleteClientScreen()
    {
        clsDeletClient::DeletClint();
    }
    ...
    {
        clsFindClient::ShowFindClientList();
    }
    ...
    {
        clsRegisterScreen::ShowLoginRegisterScreen();
    }
    ...
    public:
        static  void ShowMainMenue()
        {
            ...
            cout << setw(37) << left << "" << "\t[8] Show Register.\n";
